...
class ResetPasswordController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        ...
        if ($request->get('email')) {
            ...
            if ($user) {
                ...
                //$reset_password->setCreatedAt(new DateTime()); //Symfony 5
                $reset_password->setCreatedAt(new \DateTimeImmutable()); //Symfony 6
    ...
    //public function update(Request $request, $token, UserPasswordEncoderInterface $encoder): Response //Symfony 5
    public function update(Request $request, $token, UserPasswordHasherInterface $encoder): Response     //Symfony 6

    {
        ...
        if ($form->isSubmitted() && $form->isValid())
        {
            ...
            $password = $encoder->hashPassword($reset_password->getUser(), $new_pwd); //Symfony 6
